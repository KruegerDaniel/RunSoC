...
#Periods in microseconds (paper uses milliseconds)
PERIOD_DISTRIBUTION = [
    (1000, 0.03),
    (2000, 0.02),
    (5000, 0.02),
...
ACET_US_BY_PERIOD = {
    1000: {"min": 0.34, "avg": 5.00, "max": 30.11},
    2000: {"min": 0.32, "avg": 4.20, "max": 40.69},
    5000: {"min": 0.36, "avg": 11.04, "max": 83.38},
    10000: {"min": 0.21, "avg": 10.09, "max": 309.87},
    20000: {"min": 0.25, "avg": 8.74, "max": 291.42},
    50000: {"min": 0.29, "avg": 17.56, "max": 92.98},
    100000: {"min": 0.21, "avg": 10.53, "max": 420.43},
    200000: {"min": 0.22, "avg": 2.56, "max": 21.95},
    1000000: {"min": 0.37, "avg": 0.43, "max": 0.46},
