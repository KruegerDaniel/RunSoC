...
import RunnableConfigPanel from '../_components/runnable-config/RunnableConfigPanel';
import RunnablePlayground from '../_components/runnable-graph/RunnablePlayground';
    ...
    const edges: Edge[] = useMemo(() => {
        ...
        return runnables.flatMap((runnable) =>
            (runnable.dependencies ?? [])
                .filter((depId) => existingIds.has(depId))
                .map((depId) => ({
