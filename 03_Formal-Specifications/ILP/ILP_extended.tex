...
\begin{itemize}
    ...
    \item \textbf{Soft Memory Budgets:} Budgets remain modeled as soft constraints to ensure model feasibility, relying on penalty scaling ($\lambda_{\mathrm{core}}$, $\lambda_{\mathrm{cluster}}$) to enforce preferred hardware limits.
\end{itemize}
